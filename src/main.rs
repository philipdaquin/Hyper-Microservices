...
const INDEX: &'static str = r#"
    ...
    <html>
        <head>
            <title>Rust Hyper Crate Test</title>
        </head>
        <body>
            <h1>This is running on Hyper Crate</h1>
            <b>This is Fullstack Rust</b>
            <img src="https://upload.wikimedia.org/wikipedia/commons/d/d5/Rust_programming_language_black_logo.svg" width="214" height="204">
        </body>
...
fn client_handler(req: Request<Body>, user_db: &UserDb) -> impl Future<Item=Response<Body>, Error=Error> { 
...
fn main() {
    ...
    let server = builder.serve(move || {
        ...
        service_fn(move |req| client_handler(req, &user_db))  
